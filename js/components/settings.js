const SettingsTemplate = {props: [], 
        ...
        <div>
            <div>
                 <md-tabs>
                  <md-tab id="tab-home" md-label="Chat">
                    <div>
                            <md-list>
                  ...
                  <md-tab id="tab-pages" md-label="Home">
                        <div>
                      ...
                      <md-tab id="tab-posts" md-label="New Project">
                            <div>
                                <md-dialog-confirm
                    ...
                    <md-tab id="tab-help" md-label="Help">
                            <div>
                      ...
                      <md-tab id="tab-favorites" md-label="Profile">
                            <div>
